...
const projects = [
  ...
  },
  {
    ...
    description: "Automated large-scale SEO strategies for dynamic websites.",
    tags: ["SEO", "Automation", "Scalability"],
    imageUrl: "https://placehold.co/600x400/f5f5f5/cccccc?text=Programmatic+SEO",
  },
  {
    title: "Shopify SEO",
    description: "Optimized Shopify stores for better search visibility and conversions.",
    tags: ["SEO", "Shopify", "E-commerce"],
    imageUrl: "https://placehold.co/600x400/f5f5f5/cccccc?text=Shopify+SEO",
  },
  {
    title: "B2B SEO",
    description: "Developed targeted SEO strategies for B2B companies to generate qualified leads.",
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project, index) => (
                <div key={index} className="neo-blur rounded-xl overflow-hidden transition-all duration-300 hover-scale">
